...
const HomeCards = () => {
  return(
    <div id="homepgcards">
    <CardDeck>
      <Card id="homecardtext">
        <Card.Body>
          <Card.Title>HTML</Card.Title>
          <Card.Text>
          HTML is the abbreviation for Hyper Text Markup Language, and is the code, 
          or language that is used for the creation of basic website layouts. 
          It can look a little daunting if you've never done any coding before, 
          but all you need to try it out is an ordinary text editing application and 
          an internet browser.
          </Card.Text>
        </Card.Body>
      </Card>
      <Card>
        <Card.Body>
          ...
          also a high-level, general-purpose programming language. Developers 
          designed it to become a chameleon of the programming world.
          </Card.Text>
        </Card.Body>
      </Card>
      <Card>
      ...
      <Card>
        <Card.Body>
          ...
          It's used for handling the view layer for web and mobile apps. React also allows us to create reusable UI components. React was first 
